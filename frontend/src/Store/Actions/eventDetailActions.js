...
export const section = 'eventDetails';
...
export const filterPredicates = {
  ...
  nextEvent: function(item, filterValue, type) {
    return dateFilterPredicate(item.nextEvent, filterValue, type);
  },

  previousEvent: function(item, filterValue, type) {
    return dateFilterPredicate(item.previousEvent, filterValue, type);
  },
