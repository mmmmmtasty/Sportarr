...
import SeriesHistoryModal from 'Events/History/EventHistoryModal';
...
import SeriesAlternateTitles from './EventAlternateTitles';
import SeriesDetailsLinks from './EventDetailsLinks';
import SeriesDetailsSeason from './EventDetailsSeason';
import SeriesProgressLabel from './EventProgressLabel';
import SeriesTags from './EventTags';
