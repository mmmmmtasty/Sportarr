...
import DeleteSeriesModal from './Delete/DeleteEventModal';
import EditSeriesModal from './Edit/EditEventModal';
import OrganizeSeriesModal from './Organize/OrganizeEventModal';
import ChangeMonitoringModal from './SeasonPass/ChangeMonitoringModal';
import TagsModal from './Tags/TagsModal';
import styles from './EventIndexSelectFooter.css';
