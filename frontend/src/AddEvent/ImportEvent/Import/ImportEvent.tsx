...
import ImportSeriesTable from './ImportEventTable';
...
function ImportSeries() {
  ...
  const defaultQualityProfileId = useAddEventOption('qualityProfileId');
  ...
  useEffect(() => {
    if (
      ...
      setAddEventOption('qualityProfileId', qualityProfiles[0].id);
    }
