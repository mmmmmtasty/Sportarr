...
import EventAppState, { EventIndexAppState } from './EventAppState';
...
interface AppState {
  ...
  importEvents: ImportSeriesAppState;
  ...
  events: EventAppState;
  eventDetails: EventAppState;
  eventHistory: SeriesHistoryAppState;
  eventIndex: EventIndexAppState;
